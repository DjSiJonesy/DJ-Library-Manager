...
public partial class WorkflowMediaFolderRow : UserControl
{
    public WorkflowMediaFolderRow()
    {
        InitializeComponent();
    }
    ...
    public static readonly StyledProperty<string> FolderProperty =
        AvaloniaProperty.Register<WorkflowMediaFolderRow, string>(
            nameof(Folder),
            string.Empty);
    ...
    public static readonly StyledProperty<int> AudioCountProperty =
        AvaloniaProperty.Register<WorkflowMediaFolderRow, int>(
            nameof(AudioCount));
